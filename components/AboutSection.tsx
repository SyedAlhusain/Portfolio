...
//             <br />
//             <p>
//               Proficient in data analysis, I have internship experience using FileNet, and I hold certifications in SQL, Machine Learning, DevOps, and AWS. Goal-driven with a talent for solving problems using a data-driven approach, I am known for my collaborative nature and strong work ethic.
//             </p>
//             <br />
//             <p>
...
//             </p>
//             <br />
//             <a href="https://782b8ba1-e9c9-4458-a8c3-262498a2091d.filesusr.com/ugd/40204f_b80e597b6830450cae2c45c93fcc8230.pdf" className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Download Resume</a>
//           </div>
//           <div className="text-center md:w-1/2 md:text-left">
//             <h1 className="text-2xl font-bold mb-6">My Skills</h1>
//             <div className="flex flex-col justify-center z-10 md:justify-start">
