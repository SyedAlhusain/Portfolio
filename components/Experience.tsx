    ...
    <section id="experience">
      <div className="my-12 pb-12 md:pt-16 md:pb-48">
        ...
        <div className="flex justify-center">
          <a href="https://0c904d67-f597-4bd7-9686-0e6cb225c34e.filesusr.com/ugd/40204f_a6356c289eec4b238c4cfdcee95ecbdc.pdf" className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mt-8">Download Resume</a>
        </div>
      </div>
    </section>
  );
